...
\end{itemize}
\begin{definizione}{Insiemi uguali}
	...
	\]
\end{definizione}
\begin{definizione}{Insieme vuoto}
...
\begin{definizione}{Insieme contenuto}
...
\begin{definizione}{Definire degli insiemi}
	...
	\end{itemize}
\end{definizione}
\begin{definizione}{Operazioni su insiemi}
...
\end{definizione}
\begin{definizione}{Funzione parziale}
...
\begin{definizione}{Dominio e immagine}
...
\begin{definizione}{Funzione totale}
...
\end{definizione}
\begin{definizione}{Iniettività, surgettività e bigettività}
...
\begin{definizione}{Insiemi equipotenti}
...
\end{itemize}
\begin{teorema}{Cardinalità e equipotenza}
...
\begin{itemize}
	\item Siam $ n \in  \N \setminus \left\{0\right\}$ allora  $\exists ! n \in  \N \text{ t.c. } succ\left(m\right) = n $. In questo caso $ n  $ è detto predecessore di $ m $
	      ...
	      \end{itemize}
\end{itemize}
\begin{teorema}{Principio di induzione di prima forma}
...
\begin{teorema}{Teorema di ricorsione}
...
\begin{definizione}{Operatore minore uguale}
...
\begin{definizione}{Ordinamento di un insieme}
...
\begin{teorema}{Principio di induzione shiftato di prima forma}
...
\begin{definizione}{Insieme finito}
...
\begin{teorema}{Teorema dei cassetti}
...
\begin{teorema}{Colorrario a teorema dei cassetti}
...
\begin{definizione}{Buon ordinamento}
...
\begin{teorema}{Buon ordinamento dei numeri naturali}
...
\begin{teorema}{Esistenza ed unicità della divisione euclidea}
...
\end{teorema}\label{divisioneeuclidea}
...
\begin{definizione}{Rappresentazione numeri naturali}
...
\begin{teorema}{Rappresentabilità dei naturali in base $ b $}
...
\hypertarget{teomcd}{}
\begin{teorema}{Esistenza ed unicità M.C.D}
...
\]
\begin{teorema}{Implicazioni numeri coprimi}
...
\end{definizione}
\begin{teorema}{Corollario su numeri primi}
...
\end{center}
\begin{definizione}{Minimo comune multiplo}
...
\begin{definizione}{Relazione d'equivalenza}
...
\begin{definizione}{Classe d'equivalenza}
...
\begin{definizione}{Classe di congruenza}
...
\begin{teorema}{Resto classi di congruenza }
...
\begin{definizione}{Somma e prodotto di classi di congruenza}
	\begin{itemize}
...
\begin{definizione}{Inverso modulare}
...
\end{definizione}
\begin{teorema}{Condizione invertibilità modulare}
...
\begin{itemize}
	...
	\item $ \Leftarrow $
	      ...
	      \end{itemize}
\end{itemize}
\begin{teorema}{Unicità inverso modulare}
...
\begin{teorema}{Sistemi lineari modulari}
	...
	\]
\end{teorema}\label{Sistemi lineari}
\subsubsection*{Dimostrazione}
\begin{itemize}
	\item $ \Rightarrow  $
	      \begin{itemize}
...
\begin{definizione}{Insiemi classi invertibili}
...
\end{definizione}
\begin{teorema}{Classi invertibili modulo numero primo}
...
\begin{itemize}
	...
	\item Ogni altra classe $ \left[c\right]_p $ è invertibile in quanto $ \left(c,p\right) $ e sempre $ 1 $ in quanto:
	      ...
	      \end{itemize}
\end{itemize}
\begin{teorema}{Invertibilità prodotto}
...
\end{itemize}
\begin{definizione}{Phi di eulero}
...
\begin{teorema}{Teorema di Fermat-Eulero}
	Sia $ u \in  \Z/_{n\Z} ^{*} $, allora $ u ^{ \phi \left(n\right)} = 1  $ (in $ \Z/_{n\Z}  $)
\end{teorema}\label{Potenza di phi}
\subsubsection*{Dimostrazione}
...
\begin{teorema}{Phi di eulero numeri comprimi}
...
\begin{itemize}
	...
	\item Per questa ragione posso calcolare la phi di Eulero nel seguente modo:
	      i
\end{itemize}
\begin{teorema}{Formula generale calcolo $ \phi $ di eulero}
...
\hypertarget{teorsa}{}
\begin{teorema}{Teorema base crittografia RSA}
...
\]
\section{Grafi}
\begin{definizione}{2-sottoinsieme}
...
\end{definizione}
\begin{teorema}{Cardinalità 2-sottoinsieme}
...
\begin{definizione}{Morfismo di grafo}
...
\begin{definizione}{Isomorfismo di grafo}
...
\end{definizione}
\begin{teorema}{Condizione isomorfismo}
...
\begin{minipage}[c]{0.68\textwidth}
	...
	\end{minipage}
\end{minipage}
\begin{definizione}{Passeggiate cammini e cicli}
...
\begin{definizione}{Confiungibilità}
	...
	\]
\end{definizione}
\begin{teorema}{Congiungibilità per cammino o passeggiata}
...
\begin{itemize}
	...
	\item Viceversa, se $ v $ e $ k $ sono congiungibili in passeggiata, posso scegliere la passeggiata più corta, evitando di ritornare sui miei passi
	      ...
	      \end{itemize}
\end{itemize}
\begin{definizione}{Grafi connessi}
...
\begin{definizione}{Operazioni sui grafi}
	...
	\end{itemize}
\end{definizione}
\begin{definizione}{Grafo 2-connesso}
...
\end{definizione}
\begin{definizione}{Grafo hamiltoniano}
...
\begin{definizione}{Grafo finito}
...
\begin{itemize}
	...
	\item La quantità della sommatoria interna a destra è sempre pari a 2 (fisso un lato e contro quanti vertici lo contengono, sempre 2). Visto che la sommatoria esterna varia da $ 1 $ a $ k $, dove $ k $ è il numero dei lati, allora la quantità di destra è pari a $ 2 \left|E\right| $
	      ...
	      \]
\end{itemize}
\begin{teorema}{Teorema delle strette di mano}
...
\begin{teorema}{Foglie grafo hamiltoniano}
...
\begin{center}
	...
	\end{tikzpicture}
\end{center}
\begin{teorema}{Proprietà grafi isomorfi}
...
\end{itemize}
\begin{teorema}{Condizione esistenza score 1}
...
\begin{teorema}{Condizione esistenza score 2}
...
\begin{itemize}
	...
	\item Tutta via posso trimmare via gli zero davanti e appricare il metodo 3
	      ...
	      \]
\end{itemize}
\begin{teorema}{Condizione esitenza score 3}
...
\begin{center}
	...
	\end{tikzpicture}
\end{center}
\begin{teorema}{Condizione esitenza score 4}
...
\end{teorema}
\begin{teorema}{Prerequisito teorema dello score}
	...
	\end{center}
\end{teorema}\label{score banale}
\begin{teorema}{Teorema dello score}
...
\begin{definizione}{Alberi e foreste}
...
\begin{teorema}{Caratterizzazione alberi}
...
\begin{teorema}{Formula di eulero per gli alberi}
...
\begin{teorema}{Corollario 1 a teorema di Eulero per i grafi}
...
\begin{teorema}{Corollario 2 a teorema di Eulero per i grafi}
...
\begin{teorema}{Forzatura alla connessione}
...
\begin{definizione}{Albero di copertura, spanning tree}
...
\begin{teorema}{Esistenza albero di copertura}
